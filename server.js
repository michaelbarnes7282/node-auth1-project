...
const sessions = require('express-session'); // install this library
...
const sessionConfig = {
  ...
  resave: false,
  saveUninitialized: true, // GDPR compiance, read the docs
  store: new KnexSessionStore({
    knex: dbConnection,
    tablename: 'sessions',
    sidfiledname: 'sid',
    createtable: true,
    clearInterval: 60000, // delete expired sessions - in milliseconds
  })
}
